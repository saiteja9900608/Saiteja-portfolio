...
const projects = [
  ...
  },
  {
    ...
    description: 'Classifies user comments using Logistic Regression, SVM, Naive Bayes.',
  },
  {
    ...
    <section id="projects" className="p-10 bg-white">
      ...
      <div className="grid md:grid-cols-2 gap-6">
        {projects.map((proj, index) => (
          <div key={index} className="bg-gray-100 p-6 rounded-xl shadow hover:scale-105 transition-transform duration-300">
